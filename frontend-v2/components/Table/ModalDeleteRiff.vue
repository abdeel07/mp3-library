...
<template>
    ...
    <div class="modal" role="dialog">
        <div class="modal-box">
            ...
            <div class="">
                <h3 class="text-left font-bold text-lg p-4">Delete Riff</h3>
            </div>
            <div class="flex flex-col items-center justify-center">
                ...
                <div>
                    <p class="p-4 text-base font-semibold">Are you sure you want to delete this Riff?</p>
                    <button @click="onSubmit" class="btn btn-neutral w-full hover:btn-error">Delete Riff</button>
                </div>
            </div>
        </div>
    </div>
